...
set myClk    clk
#set myDesign mul_unsigned
#set myDesign mul_unsigned_for4
#set myDesign mul_unsigned_for
#set myDesign mul_unsigned_untree
#set myDesign mul_fixed
set myDesign mul_unsigned_pipeline
