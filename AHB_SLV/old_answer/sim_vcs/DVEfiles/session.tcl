...
# DVE full session
# Saved on Sat May 12 21:23:31 2018
# Designs open: 1
#   V1: /qixin/proj_users/cary/training/soc_training_2018_0415/design_labs/ahb_slave/sim_vcs/aaa.vcd
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{-498 59} {1409 1050}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 165} {height 707} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 280} {height 707} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1907} {height 177} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/qixin/proj_users/cary/training/soc_training_2018_0415/design_labs/ahb_slave/sim_vcs/aaa.vcd}] } {
	gui_open_db -design V1 -file /qixin/proj_users/cary/training/soc_training_2018_0415/design_labs/ahb_slave/sim_vcs/aaa.vcd -nosource
}
...
catch {gui_list_select -id ${Hier.1} {ahb_clac_top_tb.ahb_write}}
...
gui_list_show_data -id ${Data.1} {ahb_clac_top_tb.ahb_write}
